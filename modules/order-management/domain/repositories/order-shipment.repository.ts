...
export interface IOrderShipmentRepository {
  ...
  findByOrderId(orderId: string, options?: ShipmentQueryOptions): Promise<OrderShipment[]>;
  findByTrackingNumber(trackingNumber: string): Promise<OrderShipment | null>;
  findByCarrier(carrier: string, options?: ShipmentQueryOptions): Promise<OrderShipment[]>;
