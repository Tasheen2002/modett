...
export interface IOrderEventRepository {
  ...
  findByOrderId(orderId: string, options?: OrderEventQueryOptions): Promise<OrderEvent[]>;
  findByEventType(eventType: string, options?: OrderEventQueryOptions): Promise<OrderEvent[]>;
  findByOrderIdAndEventType(orderId: string, eventType: string, options?: OrderEventQueryOptions): Promise<OrderEvent[]>;
