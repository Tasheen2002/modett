...
export interface IOrderItemRepository {
  ...
  findByOrderId(orderId: string, options?: OrderItemQueryOptions): Promise<OrderItem[]>;
  findByVariantId(variantId: string, options?: OrderItemQueryOptions): Promise<OrderItem[]>;
  ...
  existsByOrderIdAndVariantId(orderId: string, variantId: string): Promise<boolean>;
}
