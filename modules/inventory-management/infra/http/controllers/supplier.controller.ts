...
export class SupplierController {
  ...
  constructor(private readonly supplierService: SupplierManagementService) {
    ...
    this.createSupplierHandler = new CreateSupplierCommandHandler(supplierService);
    this.updateSupplierHandler = new UpdateSupplierCommandHandler(supplierService);
    this.deleteSupplierHandler = new DeleteSupplierCommandHandler(supplierService);
