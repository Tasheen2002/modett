...
import {
  ...
  CreatePickupReservationCommandHandler,
  CancelPickupReservationCommand,
  CancelPickupReservationCommandHandler,
  GetPickupReservationQuery,
  GetPickupReservationQueryHandler,
  ListPickupReservationsQuery,
  ListPickupReservationsQueryHandler,
} from "../../../application";
...
export class PickupReservationController {
  private createReservationHandler: CreatePickupReservationCommandHandler;
  private cancelReservationHandler: CancelPickupReservationCommandHandler;
  private getReservationHandler: GetPickupReservationQueryHandler;
  private listReservationsHandler: ListPickupReservationsQueryHandler;

  constructor(private readonly reservationService: PickupReservationService) {
    this.createReservationHandler = new CreatePickupReservationCommandHandler(
      reservationService
    );
    this.cancelReservationHandler = new CancelPickupReservationCommandHandler(
      reservationService
    );
    this.getReservationHandler = new GetPickupReservationQueryHandler(
      reservationService
    );
    this.listReservationsHandler = new ListPickupReservationsQueryHandler(
      reservationService
    );
  }
