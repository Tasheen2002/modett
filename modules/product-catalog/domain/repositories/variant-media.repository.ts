...
export interface IVariantMediaRepository {
  ...
  findAssociation(variantId: VariantId, assetId: MediaAssetId): Promise<VariantMedia | null>;
  ...
  getProductVariantMedia(productId: ProductId): Promise<Array<{ variantId: VariantId; media: VariantMedia[] }>>;
  copyProductVariantMedia(sourceProductId: ProductId, targetProductId: ProductId, variantMapping: Map<VariantId, VariantId>): Promise<void>;

  // Validation methods
  exists(variantId: VariantId, assetId: MediaAssetId): Promise<boolean>;
  isMediaAssociatedWithVariant(variantId: VariantId, assetId: MediaAssetId): Promise<boolean>;
  ...
  findByVariantColor(color: string, options?: VariantMediaQueryOptions): Promise<VariantMedia[]>;
  findByVariantSize(size: string, options?: VariantMediaQueryOptions): Promise<VariantMedia[]>;
