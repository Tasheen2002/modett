...
export interface ISizeGuideRepository {
  ...
  findByRegion(region: Region, options?: SizeGuideQueryOptions): Promise<SizeGuide[]>;
  findByCategory(category: string, options?: SizeGuideQueryOptions): Promise<SizeGuide[]>;
  findByRegionAndCategory(region: Region, category: string): Promise<SizeGuide | null>;
