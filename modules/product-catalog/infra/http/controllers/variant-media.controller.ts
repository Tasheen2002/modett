...
export class VariantMediaController {
  ...
  async getVariantMedia(request: FastifyRequest<{ Params: { variantId: string } }>, reply: FastifyReply) {
    try {
      ...
      const variantMedia = await this.variantMediaManagementService.getVariantMedia(variantId);
  ...
  async addMediaToVariant(request: FastifyRequest<{ Params: { variantId: string }; Body: AddMediaToVariantRequest }>, reply: FastifyReply) {
    try {
      const { variantId } = request.params;
      ...
      await this.variantMediaManagementService.addMediaToVariant(variantId, assetId);
  ...
  async removeMediaFromVariant(request: FastifyRequest<{ Params: { variantId: string; assetId: string } }>, reply: FastifyReply) {
    try {
      ...
      await this.variantMediaManagementService.removeMediaFromVariant(variantId, assetId);
  ...
  async removeAllVariantMedia(request: FastifyRequest<{ Params: { variantId: string } }>, reply: FastifyReply) {
    try {
      const { variantId } = request.params;
  ...
  async setVariantMedia(request: FastifyRequest<{ Params: { variantId: string }; Body: SetVariantMediaRequest }>, reply: FastifyReply) {
    try {
      const { variantId } = request.params;
      ...
      await this.variantMediaManagementService.setVariantMedia(variantId, assetIds);
  ...
  async addMediaToMultipleVariants(request: FastifyRequest<{ Body: AddMediaToMultipleVariantsRequest }>, reply: FastifyReply) {
    try {
      ...
      await this.variantMediaManagementService.addMediaToMultipleVariants(variantIds, assetId);
  ...
  async addMultipleMediaToVariant(request: FastifyRequest<{ Body: AddMultipleMediaToVariantRequest }>, reply: FastifyReply) {
    try {
      ...
      await this.variantMediaManagementService.addMultipleMediaToVariant(variantId, assetIds);
  ...
  async duplicateVariantMedia(request: FastifyRequest<{ Params: { sourceVariantId: string; targetVariantId: string } }>, reply: FastifyReply) {
    try {
      ...
      await this.variantMediaManagementService.duplicateVariantMedia(sourceVariantId, targetVariantId);
  ...
  async getProductVariantMedia(request: FastifyRequest<{ Params: { productId: string }; Querystring: VariantMediaQueryParams }>, reply: FastifyReply) {
    try {
      ...
      const productVariantMedia = await this.variantMediaManagementService.getProductVariantMedia(productId, options);
  ...
  async copyProductVariantMedia(request: FastifyRequest<{ Body: CopyProductVariantMediaRequest }>, reply: FastifyReply) {
    try {
      ...
      await this.variantMediaManagementService.copyProductVariantMedia(sourceProductId, targetProductId, variantMapping);
  ...
  async getVariantsUsingAsset(request: FastifyRequest<{ Params: { assetId: string } }>, reply: FastifyReply) {
    try {
      ...
      const variantIds = await this.variantMediaManagementService.getVariantsUsingAsset(assetId);
  ...
  async getAssetUsageCount(request: FastifyRequest<{ Params: { assetId: string } }>, reply: FastifyReply) {
    try {
      const { assetId } = request.params;
      ...
      const usageCount = await this.variantMediaManagementService.getAssetUsageCount(assetId);
  ...
  async getColorVariantMedia(request: FastifyRequest<{ Params: { productId: string; color: string } }>, reply: FastifyReply) {
    try {
      ...
      const colorVariantMedia = await this.variantMediaManagementService.getColorVariantMedia(
        productId,
  ...
  async getSizeVariantMedia(request: FastifyRequest<{ Params: { productId: string; size: string } }>, reply: FastifyReply) {
    try {
      ...
      const sizeVariantMedia = await this.variantMediaManagementService.getSizeVariantMedia(
        productId,
  ...
  async getUnusedAssets(request: FastifyRequest<{ Querystring: { productId?: string } }>, reply: FastifyReply) {
    try {
      ...
      const unusedAssetIds = await this.variantMediaManagementService.getUnusedAssets(productId);
  ...
  async validateVariantMedia(request: FastifyRequest<{ Params: { variantId: string } }>, reply: FastifyReply) {
    try {
      const { variantId } = request.params;
      ...
      const validation = await this.variantMediaManagementService.validateVariantMedia(variantId);
  ...
  async getVariantMediaStatistics(request: FastifyRequest<{ Params: { variantId: string } }>, reply: FastifyReply) {
    try {
      const { variantId } = request.params;
      ...
      const statistics = await this.variantMediaManagementService.getVariantMediaStatistics(variantId);
