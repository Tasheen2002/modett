  ...
  async handle(command: UpdateAddressCommand): Promise<CommandResult<UpdateAddressResult>> {
    try {
      ...
      if (command.firstName !== undefined || command.lastName !== undefined ||
          command.company !== undefined || command.addressLine1 !== undefined ||
          command.addressLine2 !== undefined || command.city !== undefined ||
          command.state !== undefined || command.postalCode !== undefined ||
          command.country !== undefined || command.phone !== undefined) {
